...
(function( $, window, document, undefined ) {
    ...
    var Toast = {
        ...
        setup: function () {
            ...
            // if ( this.options.bgColor !== false ) {
                ...
                this._toastEl.css("border-color", this.options.borderColor);
                this._toastEl.css("border-width", "1px");
                this._toastEl.css("border-style", "solid");
            // };
            // ===========================================================
            ...
            if ( this.options.icon !== false ) {
                ...
                // EO
                // ===========================================================
                this._toastEl.addClass('jq-icon-info');
                /*
                if ( $.inArray(this.options.icon, this._defaultIcons) !== -1 ) {
                    this._toastEl.addClass('jq-icon-' + this.options.icon);
                    // alert('jq-icon-' + this.options.icon);
                };
                */
                // ===========================================================
            };
    ...
    $.toast.options = {
        ...
        hideAfter: 5000,
        loader: true,
        loaderBg: '#ED7365', // #FFEA80 // Fondo barra Superior
        stack: 5,
        position: 'top-right', // 'bottom-left',
        bgColor: '#F9F9F9', // Fondo...
        textColor: '#181818', // Color texto...
