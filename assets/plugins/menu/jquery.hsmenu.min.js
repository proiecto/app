...
(function(a) {
	a.fn.hsMenu = function(b) {
		...
		return this.each(function() {
			...
			if(c.fixedMenubar == true) { a(this).addClass("sticky") } a(".toggle").click(function() {
				a(this).toggleClass("ripple-out");
				$reveal = a(this).attr("data-reveal");
				$allRevealable = ".grid-items, .user-penal, .user-info";
				if(a($reveal).hasClass("fadeInUp")) { a($reveal).removeClass("fadeInUp").fadeOut() } else { a($reveal).fadeIn().addClass("fadeInUp") } a($allRevealable).not($reveal).removeClass("fadeInUp ripple-out").fadeOut()
			});
			...
			// =====================================================
			// Buscar: Desactivado para Proiecto
			// =====================================================
			/*
			...
			a(".search-trigger").click(function() { 
				...
				if(a(this).hasClass("ripple-out")) { 
					a(".search-box").animate({ width: "250px", }, 500, function() { 
						k.focus() }
						)}
				else { 
					a(".search-box").animate({ width: "0px", }, 500);
				...
				a(".nav-fixed").on("click", function(l) {
					...
					if(l.hasClass("zmdi-unfold-more")) {
						a(g).animate({ 
							position: "fixed", 
							top: 0, }, 400, function() {
								a(g).css({ overflow: "auto", });
								l.removeClass("zmdi-unfold-more").addClass("zmdi-unfold-less")
						})
					} 
					else {
						a(g).animate({ 
							top: "50px", }, 400, function() {
								a(g).css({ overflow: "hidden", });
